...
class getPurgeCachesWhenForcedService extends phpDocumentor_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['phpDocumentor\\Pipeline\\Stage\\Cache\\PurgeCachesWhenForced'] = new \phpDocumentor\Pipeline\Stage\Cache\PurgeCachesWhenForced(($container->privates['files'] ?? ($container->privates['files'] = new \phpDocumentor\Parser\Cache\FilesystemAdapter('W+8H0KirT3'))), ($container->privates['descriptors'] ?? ($container->privates['descriptors'] = new \phpDocumentor\Parser\Cache\FilesystemAdapter('Jw+M6ztuQI'))), ($container->privates['monolog.logger'] ?? $container->load('getMonolog_LoggerService')));
    }
}

...
class getConfigureService extends phpDocumentor_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['phpDocumentor\\Pipeline\\Stage\\Configure'] = new \phpDocumentor\Pipeline\Stage\Configure($a, $a->fromDefaultLocations(), ($container->privates['monolog.logger'] ?? $container->load('getMonolog_LoggerService')), new \phpDocumentor\Parser\Cache\Locator(($container->privates['files'] ?? ($container->privates['files'] = new \phpDocumentor\Parser\Cache\FilesystemAdapter('W+8H0KirT3'))), ($container->privates['descriptors'] ?? ($container->privates['descriptors'] = new \phpDocumentor\Parser\Cache\FilesystemAdapter('Jw+M6ztuQI')))), ($container->privates['phpDocumentor\\Transformer\\Writer\\Twig\\EnvironmentFactory'] ?? $container->load('getEnvironmentFactoryService')));
    }
}
